...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `
      <p class="lead">Trends are designed to expire. True style is designed to endure. We create wallpapers that will look as sophisticated in fifty years as they do today, because we understand that the most elegant spaces are those that transcend the moment.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>A commission from us is not a transaction; it is the beginning of a long-term relationship between you, your home, and the art that adorns it.</p>
    `
  },
  {
    ...
    content: `
      <p class="lead">The difference between decoration and legacy is permanence. When you commission a hand-painted wallpaper from us, you are not purchasing a product. You are investing in a piece of art that will outlive trends, appreciate in value, and become part of your family's story for generations.</p>
      ...
      <p>Unlike printed wallpapers that depreciate the moment they leave the factory, hand-painted pieces gain value over time. They become unique artifacts, each one slightly different from the next, bearing the signature of the artist's hand. Collectors understand this: scarcity and quality create value. Our wallpaper is not just a wall covering; it is a collectible work of art.</p>
  ...
  },
  {
    ...
    content: `
      <p class="lead">A room without shadows is a room without depth. In our world, light is not just a utility; it is the active partner of our art. It reveals the texture of the silk fabric, the shimmer of the pearlescent and iridescent finishes, and the soul of the pigment.</p>
      ...
      <p>Modern lighting design often prioritizes uniform brightness. We advocate for atmosphere. Our wall demands to be lit with intention—a sconce that highlights a specific brushstroke, or a dim lamp that allows the pearlescent finish to glow softly in the gloom, revealing its hidden depths.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>The late architect John Hejduk spoke of "Masques" and "Figures"—architectural structures that were not static buildings but participants in a narrative. He believed that form could carry the weight of human experience. At our studio, we see our hand-painted panels as these figures.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>This is the essence of our lifestyle: a deep respect for the materials of the earth, the skill of the hand, and the sanctity of the home as a vessel for space, time, and memory.</p>
    `
  },
  {
  ...
  },
  {
    ...
    content: `
      <p class="lead">Realism mimics the world; abstraction interprets it. We are not interested in painting a flower exactly as it exists in nature. We are interested in how that flower feels in a memory.</p>
