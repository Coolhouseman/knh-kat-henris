      ...
      <div className="container mx-auto px-6 py-12 md:py-24">
        <div className="max-w-4xl mx-auto text-center mb-24">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            ...
            Understanding our materials is essential to appreciating the value of our commissions.
          </p>
        </div>
        ...
        <div className="space-y-32">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="w-16 h-px bg-gray-400" />
              <p className="text-gray-600 leading-relaxed">
                The signature of our wallpaper lies in its finish: pearlescent textures and iridescent effects 
          ...
          <section className="max-w-4xl mx-auto">
            <div className="space-y-6">
              ...
              <div className="w-16 h-px bg-gray-400" />
              <p className="text-gray-600 leading-relaxed">
                We do not work from a fixed color palette. The base color of each wallpaper is selected through a thoughtful 
