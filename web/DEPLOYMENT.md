...
2. Name it something like `kat-henris-website`
...
If you want to use `knh.nz` instead of `your-project.vercel.app`:

### Step 6: Add Custom Domain in Vercel

1. In Vercel dashboard, go to your project
2. Click **"Settings"** → **"Domains"**
3. Enter your domain (e.g., `knh.nz`)
...
3. Name it (e.g., `kat-henris-images`)
